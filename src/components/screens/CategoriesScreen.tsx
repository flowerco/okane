...
function CategoriesScreen() {
  ...
  return (
    <>
      <div className="h-[20%]">
        <h1 className="font-bold adjustFontTitle text-2xl uppercase text-white mb-4 text-center ">
          Spending Breakdown - {month}
        </h1>
        <div className="flex flex-nowrap justify-center overflow-scroll w-11/12 mx-auto">
          ...
          .map((filteredTrans, index) => {
            return (
              <>
                <div
                  key={index}
                  className="grid grid-cols-[_40%_40%_20%] justify-start cursor-pointer text-gray-700 hover:text-teal-400 hover:bg-teal-100 rounded-md px-2 py-3 ">
                  {/* <span className="bg-gray-400 h-2 w-2 m-2 rounded-full"></span> */}
                  <div className="flex-grow font-medium px-1 text-xl justify-self-start">
