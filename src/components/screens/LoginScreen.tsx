...
export const LoginScreen = () => {
	...
	return (
		<div className='w-full h-full flex flex-col justify-center items-center'>
			<div className='flex flex-col justify-center items-center border-2 border-white rounded-lg w-4/5 max-w-xl  h-2/5  space-y-8 py-10 -mt-16'>
				...
				>
					{registerFlag ? (
						<input
							...
							placeholder='Name'
							className='text-2xl max-w-lg rounded-md px-4'
						></input>
					) : (
						<></>
					)}
