...
export const SummaryScreen = () => {
	...
	return (
		<div className='lg:flex lg:flex-row-reverse sm:grid sm:grid-cols-1 h-full w-full sm:justify-items-center'>
			...
			<div className='lg:flex-col  lg:w-3/5 lg:h-4/5 lg:m-28 text-center'>
				...
				<div className='lg:mt-20 flex flex-col w-full px-12 mt-4 pb-6'>
					<ItemList
						data={subscriptions}
						colors={colors}
